...
С помощью команды cd переходим в каталог курса сформированный при выполнении лабораторной работы No2

![ Команда 'cd'](image/1.png){ #fig:001 width=95% }

Обновим локальный репозиторий, скачав изменения из удаленного репози-
тория с помощью команды git pull (рис. [-@fig:002])

![Команда 'git pull'](image/2.png){ #fig:002 width=95% }


Перейдем в каталог с шаблоном отчета по лабораторной работе No 3 (рис. [-@fig:003])

![Команда 'переход'](image/3.png){ #fig:003 width=95% }

Проведем компиляцию шаблона с использованием Makefile. Для этого
вводим команду make. (рис. [-@fig:004])

![Команда 'make'](image/5.png){ #fig:004 width=95% }
...
![Команда 'make clean'](image/6.png){ #fig:005 width=95% }

Откроем файл report.md c помощью команды gedit report.md (рис. [-@fig:006])

![Команда 'gedit report.md'](image/7.png){ #fig:006 width=95% }
